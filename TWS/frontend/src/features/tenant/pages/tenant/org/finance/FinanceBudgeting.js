...
const FinanceBudgeting = () => {
  ...
  const stats = [
    ...
    { label: 'Available', value: money(Math.max(totals.total - totals.allocated, 0)), icon: ArrowTrendingUpIcon, iconBg: 'bg-accent-50 dark:bg-accent-900/20', iconColor: 'text-accent-600 dark:text-accent-400' },
