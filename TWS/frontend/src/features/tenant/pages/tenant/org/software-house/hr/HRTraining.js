...
const HRTraining = () => {
  ...
  const statsData = [
    ...
    { label: 'Enrolled Employees', value: stats.enrolledEmployees.toString(), icon: VideoCameraIcon, iconBg: 'bg-accent-50 dark:bg-accent-900/20', iconColor: 'text-accent-600 dark:text-accent-400' },
